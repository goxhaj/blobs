...
class TestCases(unittest.TestCase):
    ...
    def test1(self):
        ...
        with open('tests/images/test1.jpeg', 'rb') as image_file:
    ...
    def test2(self):
        ...
        with open('tests/images/test2.png', 'rb') as image_file:
            response_put_s3 = requests.put(response_content["presigned_url"], data=image_file)
            assert(response_put_s3.status_code==200)
            response_get = requests.get(SERVICE+"/"+response_content["blob_id"])
            assert(response_get.status_code==200)
    ...
    def test3(self):
        ...
        with open('tests/images/test3.jpeg', 'rb') as image_file:
            response_put_s3 = requests.put(response_content["presigned_url"], data=image_file)
            assert(response_put_s3.status_code==200)
            response_get = requests.get(SERVICE+"/"+response_content["blob_id"])
            assert(response_get.status_code==200)
    ...
    def test4(self):
        ...
        with open('tests/images/test4.JPG', 'rb') as image_file:
            response_put_s3 = requests.put(response_content["presigned_url"], data=image_file)
            assert(response_put_s3.status_code==200)
            response_get = requests.get(SERVICE+"/"+response_content["blob_id"])
            assert(response_get.status_code==200)
    ...
    def test5(self):
        ...
        with open('tests/images/test5.jpg', 'rb') as image_file:
            response_put_s3 = requests.put(response_content["presigned_url"], data=image_file)
            assert(response_put_s3.status_code==200)
            response_get = requests.get(SERVICE+"/"+response_content["blob_id"])
            assert(response_get.status_code==200)
